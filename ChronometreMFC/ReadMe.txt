================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet ChronometreMFC
===============================================================================

L'Assistant Application a créé cette application ChronometreMFC pour  
...
constituent votre application ChronometreMFC.

ChronometreMFC.vcproj
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CChronometreMFCApp.

ChronometreMFC.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CChronometreMFCApp.


ChronometreMFCppc.rc
...
ChronometreMFCDlg.h, ChronometreMFCDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CChronometreMFCDlg.  Cette classe 
définit 
...
(PCH) 
    nommé ChronometreMFC.pch et un fichier de types précompilés nommé 
StdAfx.obj.
